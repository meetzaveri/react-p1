                ...
                <div className ="wrapper" style={{position : 'relative'}}>
                    <Slice piebg="yellow">
                        <Slice  slicedegree={ 0 - p1 } >
                            <Pie piebg={ this.props.paintShades.c1 } degree={ 252 + p1}  />
                        </Slice> 
                        <Slice clipnative slicedegree={ 72 - p2 }  z_axis={p2} >
                            <Pie clipnative piebg={ this.props.paintShades.c2 } degree={ 252 + p2 }  />
                        </Slice> 
                        <Slice clipnative slicedegree={ 144 - p3  }  z_axis={p3} >
                            <Pie clipnative piebg={ this.props.paintShades.c3 } degree={ 252 + p3 }  />
                        </Slice> 
                        <Slice clipnative slicedegree={ 216 - p4 }  z_axis={p4} >
                            <Pie clipnative piebg={ this.props.paintShades.c4 } degree={ 252 + p4 }  />
                        </Slice> 
                        <Slice clipnative slicedegree={ 288 - p5 }  z_axis={p5} >
                            <Pie clipnative piebg={ this.props.paintShades.c5 } degree={ 252 + p5}  />
                        </Slice> 
                    </Slice>
                </div> 
                 )
