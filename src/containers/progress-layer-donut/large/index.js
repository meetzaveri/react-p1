            ...
            <div style={{'marginTop' : '20%'}}>
             <Wrapper mainbg="white" >
                <div className ="wrapper" style={{position : 'relative'}}>
                    <Slice piebg="yellow">
                        <Slice  slicedegree={ 0 } >
                            <Pie mainbg={this.props.bgclr} widthoffset="22" piebg={ this.props.paintShades.c1 }  degree={ 0 } />
                        </Slice> 
                        <Slice clipnative slicedegree={ 0 }  z_axis={progress}>
                            <Pie mainbg={this.props.bgclr} clipnative widthoffset="22" piebg={ this.props.paintShades.c2 }  degree={ 180 + progress } />
                        </Slice> 
                    </Slice>
                </div> 
